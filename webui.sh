...
case "$gpu_info" in
    *"Navi 1"*)
        ...
        then
            ...
            if [[ $pyv == "3.8" ]]
            then
                export TORCH_COMMAND="uv pip install --system https://download.pytorch.org/whl/nightly/rocm5.2/torch-2.0.0.dev20230209%2Brocm5.2-cp38-cp38-linux_x86_64.whl https://download.pytorch.org/whl/nightly/rocm5.2/torchvision-0.15.0.dev20230209%2Brocm5.2-cp38-cp38-linux_x86_64.whl"
            elif [[ $pyv == "3.9" ]]
            then
                export TORCH_COMMAND="uv pip install --system https://download.pytorch.org/whl/nightly/rocm5.2/torch-2.0.0.dev20230209%2Brocm5.2-cp39-cp39-linux_x86_64.whl https://download.pytorch.org/whl/nightly/rocm5.2/torchvision-0.15.0.dev20230209%2Brocm5.2-cp39-cp39-linux_x86_64.whl"
            elif [[ $pyv == "3.10" ]]
            then
                export TORCH_COMMAND="uv pip install --system https://download.pytorch.org/whl/nightly/rocm5.2/torch-2.0.0.dev20230209%2Brocm5.2-cp310-cp310-linux_x86_64.whl https://download.pytorch.org/whl/nightly/rocm5.2/torchvision-0.15.0.dev20230209%2Brocm5.2-cp310-cp310-linux_x86_64.whl"
            else
    ...
    *"Navi 3"*) [[ -z "${TORCH_COMMAND}" ]] && \
         export TORCH_COMMAND="uv pip install --system torch torchvision --index-url https://download.pytorch.org/whl/nightly/rocm5.7"
    ;;
...
then
    ...
    then
	      export TORCH_COMMAND="uv pip install --system torch torchvision torchaudio --index-url https://download.pytorch.org/whl/rocm5.7"
    elif npu-smi info 2>/dev/null
    then
        export TORCH_COMMAND="uv pip install --system torch==2.1.0 torchvision torchaudio --index-url https://download.pytorch.org/whl/cpu; uv pip install --system torch_npu==2.1.0"
    fi
fi
...
then
    ...
    then
        ...
        "${venv_dir}"/bin/python -m uv pip install --system --upgrade pip
        first_launch=1
    fi
    # shellcheck source=/dev/null
